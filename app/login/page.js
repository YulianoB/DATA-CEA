  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (json.status === 'success') {
        ...
        setError(json.message || 'Usuario o contraseña incorrectos')
      }
    } catch (err) {
      console.error(err)
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="flex-1 bg-gradient-to-br from-[var(--primary)] to-[var(--primary-dark)] text-white flex flex-col items-center justify-center p-10">
        <div className="absolute bottom-0 left-0 w-80 h-80 opacity-40"
          style={{
            backgroundImage: `
        ...
        <div className="absolute bottom-0 left-0 w-92 h-92 opacity-40 rounded-full overflow-hidden"
          style={{
            backgroundImage: `
